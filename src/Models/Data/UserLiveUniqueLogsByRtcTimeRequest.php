...
/**
 * 根据讲者上下线时间做用户观看时长统计并合并用户终端
 * Class UserLiveRequest
 * @package eDoctor\Meeting\Models\Data
 */
class UserLiveUniqueLogsByRtcTimeRequest extends TlkRequest
{

    const REQUEST_METHOD = TypeData::METHOD_GET;

    const REQUEST_URI = 'open/room/%d/user_live_uniquelogs_by_rtc_time';

    /**
     * UserLiveUniqueLogsByRtcTimeRequest constructor.
     * @param $roomId
